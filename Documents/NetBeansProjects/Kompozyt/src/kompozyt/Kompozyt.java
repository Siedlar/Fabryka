         ...
         switch(a){
             case 1: 
                ...
                lech.dodaj(leaf83);
                 ...
                 JednostkaPodstawowa leaf991= new JednostkaPodstawowa("Kuciak","Bramkarz");
                 JednostkaPodstawowa leaf91= new JednostkaPodstawowa("Nalepa","Obrońca");
                 JednostkaPodstawowa leaf92= new JednostkaPodstawowa("Augustyn","Obrońca");
                 JednostkaPodstawowa leaf93= new JednostkaPodstawowa("Mladenovic","Obrońca");
                 JednostkaPodstawowa leaf94= new JednostkaPodstawowa("Nunes","Obrońca");
                 JednostkaPodstawowa leaf95= new JednostkaPodstawowa("Łukasik","Pomocnik");
                 JednostkaPodstawowa leaf96= new JednostkaPodstawowa("Makowski","Pomocnik");
                 JednostkaPodstawowa leaf97= new JednostkaPodstawowa("Kubicki","Pomocnik");
                 JednostkaPodstawowa leaf98= new JednostkaPodstawowa("Paixao","Napastnik");
                 JednostkaPodstawowa leaf99= new JednostkaPodstawowa("Sobiech","Napastnik");
                 JednostkaPodstawowa leaf910= new JednostkaPodstawowa("Haraslij","Napastnik");
                 JednostkaPodstawowa leaf911= new JednostkaPodstawowa("Piotr Stokowiec","Trener");
                ...
                case 10: 
                 ...
                 JednostkaPodstawowa leaf121= new JednostkaPodstawowa("Cierzniak","Bramkarz");
                 JednostkaPodstawowa leaf122= new JednostkaPodstawowa("Vesovic","Obrońca");
                 JednostkaPodstawowa leaf123= new JednostkaPodstawowa("Jedrzejczyk","Obrońca");
                 JednostkaPodstawowa leaf120= new JednostkaPodstawowa("Remy","Obrońca");
                 JednostkaPodstawowa leaf124= new JednostkaPodstawowa("Rocha","Obrońca");
                 JednostkaPodstawowa leaf125= new JednostkaPodstawowa("Martins","Pomocnik");
                 JednostkaPodstawowa leaf126= new JednostkaPodstawowa("Cafu","Pomocnik");
                 JednostkaPodstawowa leaf127= new JednostkaPodstawowa("Hamalainen","Pomocnik");
                 JednostkaPodstawowa leaf128= new JednostkaPodstawowa("Szymański","Pomocnik");
                 JednostkaPodstawowa leaf129= new JednostkaPodstawowa("Nagy","Pomocnik");
                 JednostkaPodstawowa leaf1210= new JednostkaPodstawowa("Carlitos","Napastnik");
                 JednostkaPodstawowa leaf1211= new JednostkaPodstawowa("Vukovic","Trener");
                ...
                case 11:
                 ...
                 JednostkaPodstawowa leaf131= new JednostkaPodstawowa("Plach","Bramkarz");
                 JednostkaPodstawowa leaf132= new JednostkaPodstawowa("Pietrowski","Obrońca");
                 JednostkaPodstawowa leaf133= new JednostkaPodstawowa("Czerwiński","Obrońca");
                 JednostkaPodstawowa leaf130= new JednostkaPodstawowa("Sedlar","Obrońca");
                 JednostkaPodstawowa leaf134= new JednostkaPodstawowa("Kirkeskov","Obrońca");
                 JednostkaPodstawowa leaf135= new JednostkaPodstawowa("Hateley","Pomocnik");
                 JednostkaPodstawowa leaf136= new JednostkaPodstawowa("Badia","Pomocnik");
                 JednostkaPodstawowa leaf137= new JednostkaPodstawowa("Felix","Pomocnik");
                 JednostkaPodstawowa leaf138= new JednostkaPodstawowa("Dziczek","Pomocnik");
                 JednostkaPodstawowa leaf139= new JednostkaPodstawowa("Konczkowski","Pomocnik");
                 JednostkaPodstawowa leaf1310= new JednostkaPodstawowa("Parzyszek","Napastnik");
                 JednostkaPodstawowa leaf1311= new JednostkaPodstawowa("Fornalik","Trener");
                ...
                korona.dodaj(leaf133);
                 ...
                 JednostkaPodstawowa leaf141= new JednostkaPodstawowa("Forenc","Bramkarz");
                 JednostkaPodstawowa leaf142= new JednostkaPodstawowa("Kopacz","Obrońca");
                 JednostkaPodstawowa leaf143= new JednostkaPodstawowa("Guldan","Obrońca");
                 JednostkaPodstawowa leaf140= new JednostkaPodstawowa("Oko","Obrońca");
                 JednostkaPodstawowa leaf144= new JednostkaPodstawowa("Balic","Obrońca");
                 JednostkaPodstawowa leaf145= new JednostkaPodstawowa("Slisz","Pomocnik");
                 JednostkaPodstawowa leaf146= new JednostkaPodstawowa("Poreba","Pomocnik");
                 JednostkaPodstawowa leaf147= new JednostkaPodstawowa("Pawłowski","Pomocnik");
                 JednostkaPodstawowa leaf148= new JednostkaPodstawowa("Starzynski","Pomocnik");
                 JednostkaPodstawowa leaf149= new JednostkaPodstawowa("Bohar","Pomocnik");
                 JednostkaPodstawowa leaf1410= new JednostkaPodstawowa("Tuszynski","Napastnik");
                 JednostkaPodstawowa leaf1411= new JednostkaPodstawowa("Van Dael","Trener");
                ...
                slask.dodaj(leaf143);
                 ...
                 JednostkaPodstawowa leaf151= new JednostkaPodstawowa("Załuska","Bramkarz");
                 JednostkaPodstawowa leaf152= new JednostkaPodstawowa("Malec","Obrońca");
                 JednostkaPodstawowa leaf153= new JednostkaPodstawowa("Fojut","Obrońca");
                 JednostkaPodstawowa leaf150= new JednostkaPodstawowa("Stec","Obrońca");
                 JednostkaPodstawowa leaf154= new JednostkaPodstawowa("Nunes","Obrońca");
                 JednostkaPodstawowa leaf155= new JednostkaPodstawowa("Kozulj","Pomocnik");
                 JednostkaPodstawowa leaf156= new JednostkaPodstawowa("Podstawski","Pomocnik");
                 JednostkaPodstawowa leaf157= new JednostkaPodstawowa("Majewski","Pomocnik");
                 JednostkaPodstawowa leaf158= new JednostkaPodstawowa("Drygas","Pomocnik");
                 JednostkaPodstawowa leaf159= new JednostkaPodstawowa("Kowalczyk","Pomocnik");
                 JednostkaPodstawowa leaf1510= new JednostkaPodstawowa("Buksa","Napastnik");
                 JednostkaPodstawowa leaf1511= new JednostkaPodstawowa("Runjaic","Trener");
                ...
                miedz.dodaj(leaf153);
                 ...
                 JednostkaPodstawowa leaf161= new JednostkaPodstawowa("Peskovic","Bramkarz");
                 JednostkaPodstawowa leaf162= new JednostkaPodstawowa("Diego","Obrońca");
                 JednostkaPodstawowa leaf163= new JednostkaPodstawowa("Helik","Obrońca");
                 JednostkaPodstawowa leaf160= new JednostkaPodstawowa("Datkovic","Obrońca");
                 JednostkaPodstawowa leaf164= new JednostkaPodstawowa("Siplak","Obrońca");
                 JednostkaPodstawowa leaf165= new JednostkaPodstawowa("Hanca","Pomocnik");
                 JednostkaPodstawowa leaf166= new JednostkaPodstawowa("Dimun","Pomocnik");
                 JednostkaPodstawowa leaf167= new JednostkaPodstawowa("Gol","Pomocnik");
                 JednostkaPodstawowa leaf168= new JednostkaPodstawowa("Wdowiak","Pomocnik");
                 JednostkaPodstawowa leaf169= new JednostkaPodstawowa("Cabrera","Napastnik");
                 JednostkaPodstawowa leaf1610= new JednostkaPodstawowa("Piszczek","Napastnik");
                 JednostkaPodstawowa leaf1611= new JednostkaPodstawowa("Probierz","Trener");
                ...
                zaglebie.dodaj(leaf163);
                 ...
                 JednostkaPodstawowa leaf171= new JednostkaPodstawowa("Kelemen","Bramkarz");
                 JednostkaPodstawowa leaf172= new JednostkaPodstawowa("Runje","Obrońca");
                 JednostkaPodstawowa leaf173= new JednostkaPodstawowa("Kadlec","Obrońca");
                 JednostkaPodstawowa leaf170= new JednostkaPodstawowa("Arsenic","Obrońca");
                 JednostkaPodstawowa leaf174= new JednostkaPodstawowa("Bodvarsson","Obrońca");
                 JednostkaPodstawowa leaf175= new JednostkaPodstawowa("Romanczuk","Pomocnik");
                 JednostkaPodstawowa leaf176= new JednostkaPodstawowa("Poletanovic","Pomocnik");
                 JednostkaPodstawowa leaf177= new JednostkaPodstawowa("Guilherme","Pomocnik");
                 JednostkaPodstawowa leaf178= new JednostkaPodstawowa("Novikovas","Pomocnik");
                 JednostkaPodstawowa leaf179= new JednostkaPodstawowa("Wójcicki","Pomocnik");
                 JednostkaPodstawowa leaf1710= new JednostkaPodstawowa("Imaz","Napastnik");
                 JednostkaPodstawowa leaf1711= new JednostkaPodstawowa("Mamrot","Trener");
                ...
                gornik.dodaj(leaf173);
                 ...
                 JednostkaPodstawowa leaf181= new JednostkaPodstawowa("Putnocki","Bramkarz");
                 JednostkaPodstawowa leaf182= new JednostkaPodstawowa("Gumny","Obrońca");
                 JednostkaPodstawowa leaf183= new JednostkaPodstawowa("Kostevych","Obrońca");
                 JednostkaPodstawowa leaf180= new JednostkaPodstawowa("Jóźwiak","Obrońca");
                 JednostkaPodstawowa leaf184= new JednostkaPodstawowa("Rogne","Obrońca");
                 JednostkaPodstawowa leaf185= new JednostkaPodstawowa("Trałka","Pomocnik");
                 JednostkaPodstawowa leaf186= new JednostkaPodstawowa("Vujadinovic","Pomocnik");
                 JednostkaPodstawowa leaf187= new JednostkaPodstawowa("Tiba","Pomocnik");
                 JednostkaPodstawowa leaf188= new JednostkaPodstawowa("Jevtic","Napastnik");
                 JednostkaPodstawowa leaf189= new JednostkaPodstawowa("Klups","Napastnik");
                 JednostkaPodstawowa leaf1810= new JednostkaPodstawowa("Gytkjaer","Napastnik");
                 JednostkaPodstawowa leaf1811= new JednostkaPodstawowa("Żuraw","Trener");
